...
/// Cycling-fokussierter Tab für Gesundheitstraining
class CyclingHealthTrainingTab extends ConsumerWidget {
  const CyclingHealthTrainingTab({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final allPrograms =
        HealthTrainingProgramGenerator.generateAllPrograms(profile);

    // Finde empfohlenes Programm
    final recommendedProgram =
        HealthTrainingProgramGenerator.recommendProgram(profile,
